...
/** Cascade ease — cards “fall” down the timeline like a waterfall. */
const WATERFALL_EASE: [number, number, number, number] = [0.22, 1, 0.36, 1];
    ...
    <section ref={timelineRef} className="py-24 relative overflow-hidden mood-hope">
      <div className="container mx-auto px-6">
        <motion.div
          ...
          transition={{ duration: 0.55, ease: WATERFALL_EASE }}
        ...
        <div className="max-w-6xl mx-auto relative">
          ...
          {isInView && (
            <motion.div
              ...
              className="hidden md:block absolute left-1/2 top-0 w-0.5 bg-gradient-to-b from-blue-400 via-purple-400 to-green-400 z-10 origin-top"
            ></motion.div>
          )}
          ...
          <div className="space-y-8 md:space-y-16">
            {journeySteps.map((step, index) => {
              ...
              const fallDelay = 0.2 + index * 0.38;
